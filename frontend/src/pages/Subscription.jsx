...
const Subscription = () => {
    ...
    // Status banner config based on subscription status
    ...
    // Feature flags grouped for display
    const features = [
        { key: 'maxStaff', label: 'Staff members', value: subscription },
        { key: 'maxMenuItems', label: 'Menu items', value: subscription },
        { key: 'maxTables', label: 'Tables', value: subscription },
        { key: 'maxOrdersPerMonth', label: 'Orders per month', value: subscription },
    ];
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            {/* Status Banner */}
            {banner && (
                <div className={`border-2 rounded-lg p-4 mb-6 ${banner.color}`}>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-6">
                <div className="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">{subscription.displayStatus}</p>
                    </div>
                    <div className="text-right">
                        <p className="text-sm text-gray-500">Plan Code</p>
                        <p className="font-mono font-bold text-gray-900">{subscription.planCode}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-200">
                    <div>
                        ...
                        <p className="font-semibold text-gray-900">{formatDate(subscription.startedAt)}</p>
                    </div>
                    <div>
                ...
                {/* Monthly usage */}
                {subscription.currentMonthOrders !== null && (
            ...
            {showUpgradeButton && (
                <div className="mb-6">
                    <button
                        onClick={() => alert('Plan selection page coming soon. Razorpay integration pending.')}
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow"
                    >
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900 mb-2">About Your Subscription</h3>
